...
// import 'createObservation" function, which you will create later in 'utils/api'
import { createObservation } from "../utils/api";
// import an error handler function
import ErrorAlert from "../layout/ErrorAlert";

function ObservationCreate() {
  const history = useHistory();

  // add an 'observation' state that includes acceptance criteria
  ...
  // update submit handler to call 'createObservation()' before navigating back to home page
  // next, update the handler to set the 'error' state if there is a catch
  ...
  // add a change handler for the various form fields
  ...
  // update the return statement with form fields for acceptance criteria
  // next, update the return to include the 'ErrorAlert' component
  return (
    <main>
